...
do 
    i=8;
    j=8;
    time ./bin/conditional_density_estimation --n_inputs 1 --max_depth $i --max_depth_cond $j --T $T --data $data --joint >ring_tde_T${T}_${i}_${j}.out; 
    grep P_XY ring_tde_T${T}_${i}_${j}.out >results/ring_tde_T${T}_${i}_${j}.dat;
