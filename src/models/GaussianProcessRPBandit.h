...
#ifndef GAUSSIAN_PROCESS_RP_BANDIT_H
#define GAUSSIAN_PROCESS_RP_BANDIT_H
...
public:
	GaussianProcessRPBandit(Vector gp_scale_length, Vector gp_scale_length_dic, 
		real gp_noise_var, real gp_sig_var, real gp_threshold, real delta);
	~GaussianProcessRPBandit();
	int predict(const Matrix& X_, Vector& predictionVector, int projections, int depth); 
