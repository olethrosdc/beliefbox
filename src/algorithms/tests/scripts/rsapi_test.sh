...
do
    ...
    do
        ...
        do
            ...
            cmd="$HOME/projects/beliefbox/src/algorithms/tests/bin/rsapi --environment $environment --group --n_states $n_states --n_rollouts $n_rollouts --gamma $gamma --horizon $horizon --n_iter $n_iter"
            echo ${cmd} >$dst.cmd
