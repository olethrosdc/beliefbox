...
outdir=$HOME/results/$task/Normal
mkdir -p $outdir
...
params="--environment $task --maze_name $HOME/projects/beliefbox/dat/$maze --gamma $gamma --epsilon 0.0 --n_runs $runs --n_steps $steps --n_episodes 10000 --episode_steps -1 --pit_value 0.0 --step_value 0.001 --reward_prior Normal"
