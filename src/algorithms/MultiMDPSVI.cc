...
MultiMDPSVI::MultiMDPSVI(const Vector& w_,
...
/** Return the state-action value for the next stage.
    ...
    \f]
 */
real MultiMDPSVI::ComputeStateActionValueForSingleMDP(int mu, int s, int a)
{
    Vector& V_i = V[mu];
 ...
 */
real MultiMDPSVI::ComputeActionValueForMDPs(int s, int a)
{
    real Q_sa = 0;
...
/*** Compute the current value.
     ...
     \f]
 */
void MultiMDPSVI::ComputeStateValues(real threshold, int max_iter)
{
    pV_xi = V_xi;
    int n_iter = 0;
...
void MultiMDPSVI::ComputeStateActionValues(real threshold, int max_iter)
{
#if 1
...
FixedDiscretePolicy* MultiMDPSVI::getPolicy()
{
