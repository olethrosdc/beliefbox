...
real TdMbRt::Observe(int state, int action, real reward, int next_state, int next_action)
{
	// o Compututation
...
real TdMbRt::Observe(real reward, int next_state, int next_action)
{
	if(state >= 0)
	{
...
int TdMbRt::Act(real reward, int next_state)
{
