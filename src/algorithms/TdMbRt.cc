...
real TdMbRt::Observe(const int state, const int action, const real reward, const int next_state, const int next_action)
{
	// o Compututation
...
real TdMbRt::Observe(const real reward, const int next_state, const int next_action)
{
	if(state >= 0)
	{
