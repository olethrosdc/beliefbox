...
*/
real ConditionalKDNNClassifier::Node::Observe(const Vector& x, const int y, real probability)
{
...
*/
real ConditionalKDNNClassifier::Node::pdf(const Vector& x, const int y, real probability)
{
	real total_probability;
...
/** Recursively obtain \f$P(y | x)\f$.
*/
Vector ConditionalKDNNClassifier::Node::Output(const Vector& x, const Vector& P_y)
{
...
int ConditionalKDNNClassifier::NChildren()
{
